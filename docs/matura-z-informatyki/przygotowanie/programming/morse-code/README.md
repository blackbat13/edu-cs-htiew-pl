...
[:material-note-text: morse_alphabet.txt](../../../../assets/exam/programming/morse-code/morse_alphabet.txt)
...
[:material-note-text: morse.txt](../../../../assets/exam/programming/morse-code/morse.txt)

W pliku *morse_test.txt* znajduje się 10 linii jak opisano powyżej.

[:material-note-text: morse_test.txt](../../../../assets/exam/programming/morse-code/morse_test.txt)
